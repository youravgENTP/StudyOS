...
import { averageDailyClock, buildDailyStats, currentWeekDates, formatClockMinute } from './model'
...
export function StatsPage() {
  ...
  return <div className="page stats-page">
    <header className="stats-heading"><div><div className="eyebrow">Measured against your real week</div><h1 className="page-title">Stats</h1></div><div className="stats-period" aria-label="통계 기간"><span>월–일</span></div></header>
    ...
    {loading ? <section className="card"><p className="empty-copy">통계를 계산하는 중…</p></section> : <>
      <section className="stats-section">
        <div className="stats-section-title"><div><h2>Study capacity</h2><p>이번 주 월–일의 07:00–24:00에서 수업과 하루 3시간의 식사·씻기·이동 시간을 제외해 계산합니다.</p></div></div>
